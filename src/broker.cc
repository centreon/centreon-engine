...
void broker_program_status(int type,
  ...
  ds.global_host_event_handler = config.get_global_host_event_handler().toAscii().constData();
  ds.global_service_event_handler = config.get_global_service_event_handler().toAscii().constData();
