  ...
  for (service_map::iterator
    ...
    stream
      << "servicestatus {\n"
         ...
         "\tretry_interval=" << it->second->get_retry_interval() << "\n"
         "\tevent_handler=" << it->second->get_event_handler() << "\n"
         "\thas_been_checked=" << it->second->has_been_checked << "\n"
         ...
         "\tlast_event_id=" << it->second->last_event_id << "\n"
         "\tcurrent_event_id=" << it->second->current_event_id << "\n"
         "\tcurrent_problem_id=" << it->second->current_problem_id << "\n"
         "\tlast_problem_id=" << it->second->last_problem_id << "\n"
         "\tcurrent_attempt=" << it->second->get_current_attempt() << "\n"
         "\tmax_attempts=" << it->second->get_max_attempts() << "\n"
         "\tstate_type=" << it->second->state_type << "\n"
         "\tlast_state_change=" << static_cast<unsigned long>(it->second->last_state_change) << "\n"
         "\tlast_hard_state_change=" << static_cast<unsigned long>(it->second->last_hard_state_change) << "\n"
         "\tlast_time_ok=" << static_cast<unsigned long>(it->second->last_time_ok) << "\n"
         "\tlast_time_warning=" << static_cast<unsigned long>(it->second->last_time_warning) << "\n"
         "\tlast_time_unknown=" << static_cast<unsigned long>(it->second->last_time_unknown) << "\n"
         "\tlast_time_critical=" << static_cast<unsigned long>(it->second->last_time_critical) << "\n"
         "\tplugin_output=" << it->second->get_plugin_output() << "\n"
         "\tlong_plugin_output=" << it->second->get_long_plugin_output() << "\n"
         "\tperformance_data=" << it->second->get_perf_data() << "\n"
