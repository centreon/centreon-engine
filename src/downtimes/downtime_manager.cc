...
/**
 *  Adds a downtime in the downtime manager list. If this new downtime
 *  extends one already in the downtime manager, then the one already stored
 *  is extended with the new one.
 *
