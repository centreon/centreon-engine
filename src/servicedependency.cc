...
servicedependency::servicedependency(
  ...
  std::string const& dependency_period) : dependency(
                                            dependent_host_name,
                                            host_name,
                                            dependency_type,
                                            inherits_parent,
                                            fail_on_pending,
                                            dependency_period) {
  _dependent_service_description = dependent_service_description;
...
std::string const & servicedependency::get_dependent_service_description() const {
...
bool servicedependency::operator==(servicedependency const& obj) throw () {
  return static_cast<dependency>(*this) == obj
          && _dependent_service_description == obj.get_dependent_service_description()
...
std::ostream& operator<<(std::ostream& os, servicedependency const& obj) {
  ...
  os << "servicedependency {\n"
    ...
    "  dependent_service_description: " << obj.get_dependent_service_description() << "\n"
...
//  std::shared_ptr<servicedependency> obj(new engine::servicedependency,
