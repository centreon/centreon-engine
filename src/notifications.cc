...
int check_contact_service_notification_viability(
  ...
  if (svc->get_current_state() ==  notifier::state_unknown
  ...
  if (svc->get_current_state() ==  notifier::state_warning
  ...
  if (svc->get_current_state() ==  notifier::state_critical
  ...
  if (svc->get_current_state() ==  notifier::state_ok) {
...
int check_contact_host_notification_viability(
  ...
  if (hst->get_current_state() ==   notifier::state_down
  ...
  if (hst->get_current_state() ==   notifier::state_unreachable
