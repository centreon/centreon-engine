...
std::ostringstream& logging::operator<<(std::ostringstream& stream, service const& obj) {
  stream << "dump object\n"
    "service (" << &obj << ") {\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, sched_info const& obj) {
  stream << "dump object\n"
    "sched_info (" << &obj << ") {\n"
    "  total_services:                      " << obj.total_services << "\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, command const& obj) {
  stream << "dump object\n"
    "command (" << &obj << ") {\n"
    "  name:         " << checkstr(obj.name) << "\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, contact const& obj) {
  stream << "dump object\n"
    "contact (" << &obj << ") {\n"
    "  name:                            " << checkstr(obj.name) << "\n"
    "  alias:                           " << checkstr(obj.alias) << "\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, hostgroup const& obj) {
  stream << "dump object\n"
    "hostgroup (" << &obj << ") {\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, servicegroup const& obj) {
  stream << "dump object\n"
    "servicegroup (" << &obj << ") {\n"
    "  group_name: " << checkstr(obj.group_name) << "\n"
    "  alias:      " << checkstr(obj.alias) << "\n";
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, contactgroup const& obj) {
  stream << "dump object\n"
    "contactgroup (" << &obj << ") {\n"
    "  group_name: " << checkstr(obj.group_name) << "\n"
    "  alias:      " << checkstr(obj.alias) << "\n";
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, serviceescalation const& obj) {
  stream << "dump object\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, servicedependency const& obj) {
  stream << "dump object\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, hostescalation const& obj) {
  stream << "dump object\n"
    "hostescalation (" << &obj << ") {\n"
    "  host_name:               " << checkstr(obj.host_name) << "\n"
    "  first_notification:      " << obj.first_notification << "\n"
...
std::ostringstream& logging::operator<<(std::ostringstream& stream, hostdependency const& obj) {
  stream << "dump object\n"
    "hostdependency (" << &obj << ") {\n"
    "  dependency_type:        " << obj.dependency_type << "\n"
    "  dependent_host_name:    " << checkstr(obj.dependent_host_name) << "\n"
