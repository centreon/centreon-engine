...
char const* const deprecated::resource_file_msg =
  "         In Centreon Engine, user-defined macros can be placed directly\n"
  "         in the main configuration file. However if you wish to separate\n"
  "         macro definition from other configuration options you can use\n"
  "         the cfg_include directive.\n";
