...
std::unordered_map<std::pair<unsigned long, unsigned long>,
     std::shared_ptr<engine::service2> > const& applier::state::services() const throw () {
  return _services;
}
 ...
 */
std::unordered_map<std::pair<unsigned long, unsigned long>,
     std::shared_ptr<engine::service2> >& applier::state::services() throw () {
  return _services;
}
 ...
 */
std::unordered_map<std::pair<unsigned long, unsigned long>,
     std::shared_ptr<engine::service2> >::const_iterator applier::state::services_find(configuration::service::key_type const& k) const {
 ...
 */
std::unordered_map<std::pair<unsigned long, unsigned long>,
     std::shared_ptr<engine::service2> >::iterator applier::state::services_find(configuration::service::key_type const& k) {
  return _services.find(k);
}
  ...
  try {
    ...
    if (!verify_config && !test_scheduling) {
      ...
      for (set_service::iterator
           ...
           ++it) {
        std::unordered_map<std::pair<unsigned long, unsigned long>,
             std::shared_ptr<engine::service2> >::const_iterator
