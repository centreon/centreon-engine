 ...
 */
void applier::host::add_object(host_ptr obj) {
  // Logging.
  ...
  // Register host.
  h->next = host_list;
  applier::state::instance().hosts()[obj->host_name()] = h;
  host_list = h.get();
 ...
 */
void applier::host::modify_object(host_ptr obj) {
  // Logging.
  logger(logging::dbg_config, logging::more)
 ...
 */
void applier::host::remove_object(host_ptr obj) {
  // Logging.
  logger(logging::dbg_config, logging::more)
 ...
 */
void applier::host::resolve_object(host_ptr obj) {
  // Logging.
  logger(logging::dbg_config, logging::more)
