...
dependency::dependency(std::string const& dependent_host_name,
...
std::string const& dependency::get_dependent_host_name() const {
  return _dependent_host_name;
}

void dependency::set_dependent_host_name(std::string const& dependent_host_name) {
  _dependent_host_name = dependent_host_name;
}

std::string const& dependency::get_host_name() const {
  return _host_name;
}

void dependency::set_host_name(std::string const& host_name) {
  _host_name = host_name;
}
...
bool dependency::operator==(dependency const& obj) throw () {
  return (_dependency_type == obj.get_dependency_type()
          && _dependent_host_name == obj.get_dependent_host_name()
 ...
 */
bool dependency::operator<(dependency const& obj) throw () {
  if (_dependent_host_name != obj.get_dependent_host_name())
    return _dependent_host_name < obj.get_dependent_host_name();
  else if(_host_name != obj.get_host_name())
