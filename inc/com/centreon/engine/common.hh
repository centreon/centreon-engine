...
#define MAX_FILENAME_LENGTH \
  256 /* Max length of path/filename that Engine will process. */
#define MAX_INPUT_BUFFER                                                      \
  1024 /* Size in bytes of max. input buffer (for reading files, misc stuff). \
        */
#define MAX_COMMAND_BUFFER \
  8192 /* Max length of raw or processed command line. */
#define MAX_EXTERNAL_COMMAND_LENGTH \
