...
class state {
 public:
  ...
  set_contactgroup const& contactgroups() const throw();
  ...
  set_hostescalation const& hostescalations() const throw();
  set_hostescalation& hostescalations() throw();
  set_hostgroup const& hostgroups() const throw();
  ...
  set_serviceescalation const& serviceescalations() const throw();
  set_serviceescalation& serviceescalations() throw();
  set_servicegroup const& servicegroups() const throw();
  ...
  std::unordered_map<std::string, std::string> const& user() const throw();
