...
namespace        configuration {
  ...
  public:
    ...
    void         month_day_end(unsigned int value);
    unsigned int month_day_end() const throw ();
    void         month_day_start(unsigned int value);
    ...
    void         week_day_end_offset(unsigned int value);
    unsigned int week_day_end_offset() const throw ();
    void         week_day_start_offset(unsigned int value);
    unsigned int week_day_start_offset() const throw ();
  ...
  private:
    ...
    unsigned int _week_day_end_offset;
    unsigned int _week_day_start_offset;
