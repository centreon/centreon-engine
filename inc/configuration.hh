...
namespace com {
  namespace centreon {
	...
	struct              cpp_suck {
	  static bool       set_generic(QString const& value, configuration& config) {
	    T ret;
	...
	template<void (configuration::*ptr)(QString const&)>
	...
	typedef std::map<QString, bool (*)(QString const&, configuration& config)> methods;
