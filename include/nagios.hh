...
// int process_check_result_queue(char const*);
...
//int compare_strings(char *,char *);                     /* compares two strings for equality */
  ...
  //int my_rename(char const*,char const*);                           /* renames a file - works across filesystems */
  //int my_fcopy(char const*,char const*);                            /* copies a file - works across filesystems */
  //int my_fdcopy(char const*, char const*, int);                     /* copies a named source to an already opened destination file */

/* thread-safe version of get_raw_command_line_r() */
//extern int get_raw_command_line_r(nagios_macros *mac, command *,char const*,char **,int);
