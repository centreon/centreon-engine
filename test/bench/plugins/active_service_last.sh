...
data=$(echo "$data" | grep 'Active Services Last' | tr '/' ' ' | sed 's/  */ /g' | cut -d: -f2)
...
output="ACTIVE SERVICES LAST - last_min: $one, last_five_min: $five, last_fifteen_min: $fifteen, last_sixty_min: $sixty"
