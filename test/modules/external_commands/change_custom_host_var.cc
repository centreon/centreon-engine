 ...
 */
static int check_change_custom_host_var() {
  ...
  customvariablesmember* member = add_custom_variable_to_host(hst, "_VAR", "TEST");
  if (!member)
...
int main(int argc, char** argv) {
  ...
  unittest utest(&check_change_custom_host_var);
