 ...
 */
static int check_delay_svc_notification() {
  ...
  char const* cmd("[1317196300] DELAY_SVC_NOTIFICATION;name;description;1234567890");
...
int main(int argc, char** argv) {
  ...
  unittest utest(&check_delay_svc_notification);
