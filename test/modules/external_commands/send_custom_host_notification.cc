 ...
 */
static int check_send_custom_host_notification() {
  ...
  char const* cmd("[1317196300] SEND_CUSTOM_HOST_NOTIFICATION;name;42;author;data");
...
int main(int argc, char** argv) {
  ...
  unittest utest(&check_send_custom_host_notification);
