 ...
 */
static int check_schedule_and_propagate_host_downtime(int argc, char** argv) {
  (void)argc;
  (void)argv;
  ...
  char const* cmd("[1317196300] SCHEDULE_AND_PROPAGATE_HOST_DOWNTIME;parent;1317196300;2000000000;0;0;7200;user;comment");
...
int main(int argc, char** argv) {
  unittest utest(argc, argv, &check_schedule_and_propagate_host_downtime);
  return (utest.run());
}
