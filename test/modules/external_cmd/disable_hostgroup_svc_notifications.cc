 ...
 */
static void check_disable_hostgroup_svc_notifications() {
...
/**
 *  Check processing of disable_hostgroup_svc_notifications works.
 */
int main(int argc, char** argv) {
  ...
  try {
    ...
    check_disable_hostgroup_svc_notifications();
    engine.cleanup();
  }
