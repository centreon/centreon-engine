 ...
 */
static void check_disable_host_and_child_notifications() {
...
/**
 *  Check processing of disable_host_and_child_notifications works.
 */
int main(int argc, char** argv) {
  ...
  try {
    ...
    check_disable_host_and_child_notifications();
    engine.cleanup();
  }
