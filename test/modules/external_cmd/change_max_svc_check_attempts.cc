...
/**
 *  Run change_max_svc_check_attempts test.
 */
static void check_change_max_svc_check_attempts() {
  ...
  svc->max_attempts = 0;
  char const* cmd("[1317196300] CHANGE_MAX_SVC_CHECK_ATTEMPTS;name;description;42");
...
/**
 *  Check processing of change_max_svc_check_attempts works.
 */
int main(void) {
  try {
    check_change_max_svc_check_attempts();
  }
