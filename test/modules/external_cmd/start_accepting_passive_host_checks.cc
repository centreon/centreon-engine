...
/**
 *  Run start_accepting_passive_host_checks test.
 */
static void check_start_accepting_passive_host_checks() {
...
/**
 *  Check processing of start_accepting_passive_host_checks works.
 */
int main(int argc, char** argv) {
  QCoreApplication app(argc, argv);
  try {
    logging::engine& engine = logging::engine::instance();
    check_start_accepting_passive_host_checks();
    engine.cleanup();
  }
