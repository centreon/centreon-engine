...
/**
 *  Run disable_hostgroup_passive_svc_checks test.
 */
static void check_disable_hostgroup_passive_svc_checks() {
...
/**
 *  Check processing of disable_hostgroup_passive_svc_checks works.
 */
int main_test() {
  logging::engine& engine = logging::engine::instance();
  check_disable_hostgroup_passive_svc_checks();
  engine.cleanup();
  return (0);
}
