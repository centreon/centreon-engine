 ...
 */
static void check_disable_servicegroup_passive_svc_checks() {
...
/**
 *  Check processing of disable_servicegroup_passive_svc_checks works.
 */
int main(int argc, char** argv) {
  QCoreApplication app(argc, argv);
  try {
    logging::engine& engine = logging::engine::instance();
    check_disable_servicegroup_passive_svc_checks();
    engine.cleanup();
  }
