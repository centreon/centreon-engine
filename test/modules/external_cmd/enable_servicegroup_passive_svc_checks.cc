 ...
 */
static void check_enable_servicegroup_passive_svc_checks() {
  ...
  char const* cmd("[1317196300] ENABLE_SERVICEGROUP_PASSIVE_SVC_CHECKS;group");
...
/**
 *  Check processing of enable_servicegroup_passive_svc_checks works.
 */
int main(void) {
  try {
    check_enable_servicegroup_passive_svc_checks();
  }
