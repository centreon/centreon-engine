...
/**
 *  Run schedule_host_svc_checks test.
 */
static void check_schedule_host_svc_checks() {
...
/**
 *  Check processing of schedule_host_svc_checks works.
 */
int main(int argc, char** argv) {
  QCoreApplication app(argc, argv);
  try {
    logging::engine& engine = logging::engine::instance();
    check_schedule_host_svc_checks();
    engine.cleanup();
  }
