 ...
 */
static void check_disable_servicegroup_host_notifications() {
...
/**
 *  Check processing of disable_servicegroup_host_notifications works.
 */
int main(int argc, char** argv) {
  QCoreApplication app(argc, argv);
  try {
    logging::engine& engine = logging::engine::instance();
    check_disable_servicegroup_host_notifications();
    engine.cleanup();
  }
