 ...
 */
static void check_disable_contactgroup_host_notifications() {
  ...
  char const* cmd("[1317196300] DISABLE_CONTACTGROUP_HOST_NOTIFICATIONS;group");
...
/**
 *  Check processing of disable_contactgroup_host_notifications works.
 */
int main_test() {
  logging::engine& engine = logging::engine::instance();
  check_disable_contactgroup_host_notifications();
  engine.cleanup();
  return (0);
}
