 ...
 */
static void check_enable_hostgroup_svc_notifications() {
...
/**
 *  Check processing of enable_hostgroup_svc_notifications works.
 */
int main(int argc, char** argv) {
  QCoreApplication app(argc, argv);
  try {
    logging::engine& engine = logging::engine::instance();
    check_enable_hostgroup_svc_notifications();
    engine.cleanup();
  }
