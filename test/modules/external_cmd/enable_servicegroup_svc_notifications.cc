 ...
 */
static void check_enable_servicegroup_svc_notifications() {
...
/**
 *  Check processing of enable_servicegroup_svc_notifications works.
 */
int main_test() {
  logging::engine& engine = logging::engine::instance();
  check_enable_servicegroup_svc_notifications();
  engine.cleanup();
  return (0);
}
