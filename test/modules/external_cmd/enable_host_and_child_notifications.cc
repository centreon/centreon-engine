 ...
 */
static void check_enable_host_and_child_notifications() {
...
/**
 *  Check processing of enable_host_and_child_notifications works.
 */
int main(int argc, char** argv) {
  ...
  try {
    ...
    check_enable_host_and_child_notifications();
    engine.cleanup();
  }
