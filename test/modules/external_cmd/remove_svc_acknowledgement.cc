...
/**
 *  Run remove_svc_acknowledgement test.
 */
static void check_remove_svc_acknowledgement() {
  ...
  char const* cmd("[1317196300] REMOVE_SVC_ACKNOWLEDGEMENT;name;description");
...
/**
 *  Check processing of remove_svc_acknowledgement works.
 */
int main_test() {
  logging::engine& engine = logging::engine::instance();
  check_remove_svc_acknowledgement();
  engine.cleanup();
  return (0);
}
