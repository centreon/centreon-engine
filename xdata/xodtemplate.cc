		...
		if(!strcmp(variable,"use")){
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_contactgroup->members==NULL)
					...
					temp_contactgroup->members = resize_string(temp_contactgroup->members,strlen(temp_contactgroup->members)+strlen(value)+2);
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_contactgroup->contactgroup_members==NULL)
					...
					temp_contactgroup->contactgroup_members = resize_string(temp_contactgroup->contactgroup_members,strlen(temp_contactgroup->contactgroup_members)+strlen(value)+2);
		...
		if(!strcmp(variable,"use")){
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_hostgroup->members==NULL)
					...
					temp_hostgroup->members = resize_string(temp_hostgroup->members,strlen(temp_hostgroup->members)+strlen(value)+2);
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_hostgroup->hostgroup_members==NULL)
					...
					temp_hostgroup->hostgroup_members=resize_string(temp_hostgroup->hostgroup_members,strlen(temp_hostgroup->hostgroup_members)+strlen(value)+2);
		...
		if(!strcmp(variable,"use")){
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_servicegroup->members==NULL)
					...
					temp_servicegroup->members=resize_string(temp_servicegroup->members,strlen(temp_servicegroup->members)+strlen(value)+2);
			...
			if(strcmp(value,XODTEMPLATE_NULL)){
				if(temp_servicegroup->servicegroup_members==NULL)
					...
					temp_servicegroup->servicegroup_members=resize_string(temp_servicegroup->servicegroup_members,strlen(temp_servicegroup->servicegroup_members)+strlen(value)+2);
	...
	for(temp_contact=xodtemplate_contact_list;temp_contact!=NULL;temp_contact=temp_contact->next){
		...
		for(temp_ptr=strtok(contactgroup_names,",");temp_ptr;temp_ptr=strtok(NULL,",")){
			...
			if(temp_contactgroup->members==NULL)
				...
				new_members=resize_string(temp_contactgroup->members,strlen(temp_contactgroup->members)+strlen(temp_contact->contact_name)+2);
	...
	for(temp_contactgroup=xodtemplate_contactgroup_list;temp_contactgroup;temp_contactgroup=temp_contactgroup->next){
		...
		for(this_memberlist=temp_memberlist;this_memberlist;this_memberlist=this_memberlist->next){
			...
			if(temp_contactgroup->members==NULL)
				...
				new_members=resize_string(temp_contactgroup->members,strlen(temp_contactgroup->members)+strlen(this_memberlist->name1)+2);
				temp_contactgroup->members=new_members;
				strcat(temp_contactgroup->members,",");
		...
		while((buf=ptr)!=NULL){
			...
			if(newmembers!=NULL){
				if(temp_contactgroup->members==NULL)
					...
					temp_contactgroup->members=resize_string(temp_contactgroup->members,strlen(temp_contactgroup->members)+strlen(newmembers)+2);
					strcat(temp_contactgroup->members,",");
	...
	for(temp_host=xodtemplate_host_list;temp_host!=NULL;temp_host=temp_host->next){
		...
		for(temp_ptr=strtok(hostgroup_names,",");temp_ptr;temp_ptr=strtok(NULL,",")){
			...
			if(temp_hostgroup->members==NULL)
				...
				new_members=resize_string(temp_hostgroup->members,strlen(temp_hostgroup->members)+strlen(temp_host->host_name)+2);
	...
	for(temp_hostgroup=xodtemplate_hostgroup_list;temp_hostgroup;temp_hostgroup=temp_hostgroup->next){
		...
		for(this_memberlist=temp_memberlist;this_memberlist;this_memberlist=this_memberlist->next){
			...
			if(temp_hostgroup->members==NULL)
				...
				new_members=resize_string(temp_hostgroup->members,strlen(temp_hostgroup->members)+strlen(this_memberlist->name1)+2);
				temp_hostgroup->members=new_members;
				strcat(temp_hostgroup->members,",");
		...
		while((buf=ptr)!=NULL){
			...
			if(newmembers!=NULL){
				if(temp_hostgroup->members==NULL)
					...
					temp_hostgroup->members=resize_string(temp_hostgroup->members,strlen(temp_hostgroup->members)+strlen(newmembers)+2);
					strcat(temp_hostgroup->members,",");
...
int xodtemplate_recombobulate_servicegroups(void){
	...
	for(temp_service=xodtemplate_service_list;temp_service!=NULL;temp_service=temp_service->next){
		...
		for(temp_ptr=strtok(servicegroup_names,",");temp_ptr;temp_ptr=strtok(NULL,",")){
			...
			if(temp_servicegroup->members==NULL){
				temp_servicegroup->members = new char[strlen(temp_service->host_name)+strlen(temp_service->service_description)+2];
				strcpy(temp_servicegroup->members,temp_service->host_name);
				strcat(temp_servicegroup->members,",");
				strcat(temp_servicegroup->members,temp_service->service_description);
				}
			else{
				new_members=resize_string(temp_servicegroup->members,strlen(temp_servicegroup->members)+strlen(temp_service->host_name)+strlen(temp_service->service_description)+3);
		...
		for(temp_ptr=member_names;temp_ptr;temp_ptr=strchr(temp_ptr+1,',')){
			...
			/* this is the service description */
				...
				for(this_memberlist=temp_memberlist;this_memberlist;this_memberlist=this_memberlist->next){
					...
					if(temp_servicegroup->members==NULL){
						temp_servicegroup->members = new char[strlen(this_memberlist->name1)+strlen(this_memberlist->name2)+2];
						strcpy(temp_servicegroup->members,this_memberlist->name1);
						strcat(temp_servicegroup->members,",");
						strcat(temp_servicegroup->members,this_memberlist->name2);
					        }
					else{
						new_members=resize_string(temp_servicegroup->members,strlen(temp_servicegroup->members)+strlen(this_memberlist->name1)+strlen(this_memberlist->name2)+3);
						temp_servicegroup->members=new_members;
						strcat(temp_servicegroup->members,",");
		...
		while((buf=ptr)!=NULL){
			...
			if(newmembers!=NULL){
				if(temp_servicegroup->members==NULL)
					...
					temp_servicegroup->members=resize_string(temp_servicegroup->members,strlen(temp_servicegroup->members)+strlen(newmembers)+2);
					strcat(temp_servicegroup->members,",");
...
xodtemplate_timeperiod *xodtemplate_find_timeperiod(char *name){
	...
	return (xodtemplate_timeperiod*)skiplist_find_first(xobject_template_skiplists[X_TIMEPERIOD_SKIPLIST],&temp_timeperiod,NULL);
        }
...
xodtemplate_command *xodtemplate_find_command(char *name){
	...
	return (xodtemplate_command*)skiplist_find_first(xobject_template_skiplists[X_COMMAND_SKIPLIST],&temp_command,NULL);
        }
...
xodtemplate_contactgroup *xodtemplate_find_contactgroup(char *name){
	...
	return (xodtemplate_contactgroup*)skiplist_find_first(xobject_template_skiplists[X_CONTACTGROUP_SKIPLIST],&temp_contactgroup,NULL);
	}
...
xodtemplate_contactgroup *xodtemplate_find_real_contactgroup(char *name){
	...
	return (xodtemplate_contactgroup*)skiplist_find_first(xobject_skiplists[X_CONTACTGROUP_SKIPLIST],&temp_contactgroup,NULL);
        }
...
xodtemplate_hostgroup *xodtemplate_find_hostgroup(char *name){
	...
	return (xodtemplate_hostgroup*)skiplist_find_first(xobject_template_skiplists[X_HOSTGROUP_SKIPLIST],&temp_hostgroup,NULL);
        }
...
xodtemplate_hostgroup *xodtemplate_find_real_hostgroup(char *name){
	...
	return (xodtemplate_hostgroup*)skiplist_find_first(xobject_skiplists[X_HOSTGROUP_SKIPLIST],&temp_hostgroup,NULL);
        }
...
xodtemplate_servicegroup *xodtemplate_find_servicegroup(char *name){
	...
	return (xodtemplate_servicegroup*)skiplist_find_first(xobject_template_skiplists[X_SERVICEGROUP_SKIPLIST],&temp_servicegroup,NULL);
        }
...
xodtemplate_servicegroup *xodtemplate_find_real_servicegroup(char *name){
	...
	return (xodtemplate_servicegroup*)skiplist_find_first(xobject_skiplists[X_SERVICEGROUP_SKIPLIST],&temp_servicegroup,NULL);
       }
...
xodtemplate_servicedependency *xodtemplate_find_servicedependency(char *name){
	...
	return (xodtemplate_servicedependency*)skiplist_find_first(xobject_template_skiplists[X_SERVICEDEPENDENCY_SKIPLIST],&temp_servicedependency,NULL);
        }
...
xodtemplate_serviceescalation *xodtemplate_find_serviceescalation(char *name){
	...
	return (xodtemplate_serviceescalation*)skiplist_find_first(xobject_template_skiplists[X_SERVICEESCALATION_SKIPLIST],&temp_serviceescalation,NULL);
	}
...
xodtemplate_contact *xodtemplate_find_contact(char *name){
	...
	return (xodtemplate_contact*)skiplist_find_first(xobject_template_skiplists[X_CONTACT_SKIPLIST],&temp_contact,NULL);
        }
...
xodtemplate_contact *xodtemplate_find_real_contact(char *name){
	...
	return (xodtemplate_contact*)skiplist_find_first(xobject_skiplists[X_CONTACT_SKIPLIST],&temp_contact,NULL);
	}
...
xodtemplate_host *xodtemplate_find_host(char *name){
	...
	return (xodtemplate_host*)skiplist_find_first(xobject_template_skiplists[X_HOST_SKIPLIST],&temp_host,NULL);
        }
...
xodtemplate_host *xodtemplate_find_real_host(char *name){
	...
	return (xodtemplate_host*)skiplist_find_first(xobject_skiplists[X_HOST_SKIPLIST],&temp_host,NULL);
        }
...
xodtemplate_hostdependency *xodtemplate_find_hostdependency(char *name){
	...
	return (xodtemplate_hostdependency*)skiplist_find_first(xobject_template_skiplists[X_HOSTDEPENDENCY_SKIPLIST],&temp_hostdependency,NULL);
        }
...
xodtemplate_hostescalation *xodtemplate_find_hostescalation(char *name){
	...
	return (xodtemplate_hostescalation*)skiplist_find_first(xobject_template_skiplists[X_HOSTESCALATION_SKIPLIST],&temp_hostescalation,NULL);
        }
...
xodtemplate_hostextinfo *xodtemplate_find_hostextinfo(char *name){
	...
	return (xodtemplate_hostextinfo*)skiplist_find_first(xobject_template_skiplists[X_HOSTEXTINFO_SKIPLIST],&temp_hostextinfo,NULL);
	}
...
xodtemplate_serviceextinfo *xodtemplate_find_serviceextinfo(char *name){
	...
	return (xodtemplate_serviceextinfo*)skiplist_find_first(xobject_template_skiplists[X_SERVICEEXTINFO_SKIPLIST],&temp_serviceextinfo,NULL);
        }
...
xodtemplate_service *xodtemplate_find_service(char *name){
	...
	return (xodtemplate_service*)skiplist_find_first(xobject_template_skiplists[X_SERVICE_SKIPLIST],&temp_service,NULL);
        }
...
xodtemplate_service *xodtemplate_find_real_service(char *host_name, char *service_description){
	...
	return (xodtemplate_service*)skiplist_find_first(xobject_skiplists[X_SERVICE_SKIPLIST],&temp_service,NULL);
        }
