...
data=$(echo "$data" | grep 'Active Hosts Last' | tr '/' ' ' | sed 's/  */ /g' | cut -d: -f2)
...
output="ACTIVE HOSTS LAST - last_min: $one, last_five_min: $five, last_fifteen_min: $fifteen, last_sixty_min: $sixty"
