...
void disable_service_checks(com::centreon::engine::service2* svc) {
...
void enable_service_checks(com::centreon::engine::service2* svc) {
  time_t preferred_time(0);
  time_t next_valid_time(0);
  unsigned long attr(MODATTR_ACTIVE_CHECKS_ENABLED);
...
void enable_service_notifications(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_NOTIFICATIONS_ENABLED);
...
void disable_service_notifications(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_NOTIFICATIONS_ENABLED);
...
void remove_service_acknowledgement(com::centreon::engine::service2* svc) {
  /* set the acknowledgement flag */
...
void enable_passive_service_checks(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_PASSIVE_CHECKS_ENABLED);
...
void disable_passive_service_checks(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_PASSIVE_CHECKS_ENABLED);
...
void enable_service_event_handler(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_EVENT_HANDLER_ENABLED);
...
void disable_service_event_handler(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_EVENT_HANDLER_ENABLED);
...
void start_obsessing_over_service(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_OBSESSIVE_HANDLER_ENABLED);
...
void stop_obsessing_over_service(com::centreon::engine::service2* svc) {
  unsigned long attr(MODATTR_OBSESSIVE_HANDLER_ENABLED);
...
void set_service_notification_number(com::centreon::engine::service2* svc, int num) {
  /* set the notification number */
