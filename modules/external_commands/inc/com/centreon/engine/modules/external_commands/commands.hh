...
void enable_contact_host_notifications(std::shared_ptr<com::centreon::engine::contact> cntct);                     // enables host notifications for a specific contact
void disable_contact_host_notifications(std::shared_ptr<com::centreon::engine::contact> cntct);                    // disables host notifications for a specific contact
void enable_contact_service_notifications(std::shared_ptr<com::centreon::engine::contact> cntct);                  // enables service notifications for a specific contact
void disable_contact_service_notifications(std::shared_ptr<com::centreon::engine::contact> cntct);                 // disables service notifications for a specific contact
